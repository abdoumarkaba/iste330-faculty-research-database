...
-- Docker initialization script for faculty_research_db

-- Create database (handled by MYSQL_DATABASE env var, but ensure tables exist)
...
CREATE TABLE IF NOT EXISTS faculty_abstracts (
...
CREATE TABLE IF NOT EXISTS faculty_keywords (
...
CREATE TABLE IF NOT EXISTS public_keywords (
    keyword_id INT PRIMARY KEY AUTO_INCREMENT,
...
INSERT IGNORE INTO faculty (first_name, last_name, building, office_number, email) VALUES
('John', 'Doe', 'GOL', '2200', 'john.doe@rit.edu'),
('Jane', 'Smith', 'GOL', '2310', 'jane.smith@rit.edu'),
('Bob', 'Lee', 'GOL', '2405', 'bob.lee@rit.edu');

INSERT IGNORE INTO faculty_keywords (faculty_id, keyword) VALUES
(1, 'AI'), (1, 'Machine Learning'), (1, 'Data Science'),
(2, 'Security'), (2, 'Networking'), (2, 'Cryptography'),
(3, 'HCI'), (3, 'UX Design'), (3, 'Usability');

INSERT IGNORE INTO faculty_abstracts (faculty_id, abstract_type, abstract_text) VALUES
